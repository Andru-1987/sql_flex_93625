...
Para conectar cualquier herramienta a la base de datos se requieren **5 parámetros fundamentales**: _Host_ (`localhost` para entornos locales), _Puerto_ (`5432`), _Base de Datos_ (`postgres` por defecto), _Usuario_ (`postgres`) y la _Contraseña_ configurada en la instalación.
